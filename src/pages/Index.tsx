...
const Index = () => {
  ...
  >('landing')
  const [_showQuickStart, _setShowQuickStart] = useState(false)
  ...
  if (currentView === 'stats') {
    return (
      <PerformanceStats
        onBack={() => setCurrentView('landing')}
        onStartTraining={() => setCurrentView('game')}
      />
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center space-y-6 mb-16">
          <Badge
            variant="secondary"
            className="mb-4 px-4 py-2 text-sm font-medium bg-blue-100 text-blue-700 border-blue-200"
          >
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Enhance your working memory and cognitive performance with scientifically-validated
            N-Back exercises. Start training immediately - no signup required.
          </p>
          ...
          <div className="flex justify-center items-center mt-6 space-x-4 md:space-x-6">
            <HighContrastToggle />
            <FontSizeSelector />
            {/* Development/Testing: Clear localStorage button */}
            {process.env.NODE_ENV === 'development' && (
              <Button
                variant="outline"
                size="sm"
                onClick={() => {
                  localStorage.removeItem('nback-sessions')
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <Card
              key={index}
              className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-200"
            >
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-200 hover:transform hover:scale-105"
              >
                <CardHeader>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Observe visual positions and hear audio letters presented in sequence
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Identify when current stimuli match those from N steps back
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[...Array(9)].map((_, i) => (
                        <div
                          key={i}
                          className={`w-12 h-12 rounded border-2 ${i === 4 ? 'bg-blue-500 border-blue-600' : 'bg-white border-gray-300'}`}
                        ></div>
                      ))}
                    </div>
          ...
          <Card className="max-w-2xl mx-auto border-0 shadow-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
            <CardContent className="p-8">
              ...
              <p className="text-blue-100 mb-6 text-lg">
                Join thousands of users improving their cognitive performance with evidence-based
                training.
              </p>
