...
interface GameSetupScreenProps {
  ...
  nLevel: number
  setNLevel: (setter: (prev: number) => number) => void
  numTrials: number
  setNumTrials: (setter: (prev: number) => number) => void
  stimulusDurationMs: number
  setStimulusDurationMs: (setter: (prev: number) => number) => void
...
const GameSetupScreen = ({
  ...
  // If isPracticeMode is true, this component might not be rendered by GameInterface,
  // or it's rendered briefly. The hook handles auto-start for practice.
  // If it were to be rendered for practice, disabling controls would be appropriate.
