...
import { AdaptiveDifficultyToggle } from '@/shared/components/ui/AdaptiveDifficultyToggle';
...
export interface GameSetupScreenProps {
  ...
  nLevel: number;
  setNLevel: (updater: (prev: number) => number) => void;
  numTrials: number;
  setNumTrials: (updater: (prev: number) => number) => void;
  stimulusDurationMs: number;
  setStimulusDurationMs: (updater: (prev: number) => number) => void;
